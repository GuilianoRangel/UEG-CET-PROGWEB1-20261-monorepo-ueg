...
- **[Creating an injectable service](#creating-an-injectable-service)**
  ...
  - [Creating an injectable service with the CLI](#creating-an-injectable-service-with-the-cli)
  - [Injecting services](#injecting-services)
  - [Injecting services in other services](#injecting-services-in-other-services)
  - [What's next](#whats-next)
- **[Lazy loading services](#lazy-loading-services)**
  - [Lazily injecting a service](#lazily-injecting-a-service)
  - [Prefetching the dependency](#prefetching-the-dependency)
  - [Provide a custom prefetch trigger](#provide-a-custom-prefetch-trigger)
...
- **[Optimizing client application size with lightweight injection tokens](#optimizing-client-application-size-with-lightweight-injection-tokens)**
  - [When tokens are retained](#when-tokens-are-retained)
  - [When to use the lightweight injection token pattern](#when-to-use-the-lightweight-injection-token-pattern)
  - [Using lightweight injection tokens](#using-lightweight-injection-tokens)
